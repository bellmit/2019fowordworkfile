...
<DatabaseName>
<![CDATA[SERVER]]></DatabaseName>
</Connection>
<Query>
<![CDATA[SELECT date_format( use_time, '%Y%m' )  period,ftaxsum,ftaxnowsum,ftaxperiod,ftaxsum-ftaxnowsum ftaxleft FROM `sale_report`
where date_format( use_time, '%Y' ) ='${year}']]></Query>
<PageQuery>
<![CDATA[]]></PageQuery>
</TableData>
...
<Query>
<![CDATA[select distinct  date_format( use_time, '%Y' )  year from pay_record]]></Query>
<PageQuery>
<![CDATA[]]></PageQuery>
</TableData>
</TableDataMap>
...
<BoundsAttr x="130" y="10" width="80" height="21"/>
</Widget>
<Widget class="com.fr.form.ui.container.WAbsoluteLayout$BoundsWidget">
...
<BoundsAttr x="230" y="10" width="80" height="21"/>
</Widget>
<Widget class="com.fr.form.ui.container.WAbsoluteLayout$BoundsWidget">
...
<ReportletName>
<![CDATA[/xylink/分摊明细详情.cpt&__bypagesize__=false]]></ReportletName>
<Attr>
...
<ChartSummaryColumn name="ftaxperiod" function="com.fr.data.util.function.SumFunction" customName="当期"/>
</MoreNameCDDefinition>
</ChartDefinition>
</Chart>
...
<Features width="600" height="400"/>
<ReportletName>
<![CDATA[/xylink/分摊明细详情.cpt]]></ReportletName>
<Attr>
<DialogAttr class="com.fr.js.ReportletHyperlinkDialogAttr">
<O>
<![CDATA[]]></O>
...
<Margin top="0" left="0" bottom="0" right="0"/>
<Border>
<border style="1" color="-657929" borderRadius="0" type="1" borderStyle="0"/>
<WidgetTitle>
<O>
<![CDATA[=\"  \"+$year+\"年摊销对比分析\"]]></O>
<FRFont name="微软雅黑" style="0" size="96"/>
<Position pos="2"/>
<Background name="ColorBackground" color="-1"/>
</WidgetTitle>
...
<CategoryName value="period"/>
<ChartSummaryColumn name="ftaxsum" function="com.fr.data.util.function.SumFunction" customName="累计摊销"/>
<ChartSummaryColumn name="ftaxleft" function="com.fr.data.util.function.SumFunction" customName="剩余摊销"/>
</MoreNameCDDefinition>
</ChartDefinition>
</Chart>
<tools hidden="true" sort="true" export="true" fullScreen="true"/>
...
<O t="XMLable" class="com.fr.base.Formula">
<Attributes>
<![CDATA[="  "+$year+"年摊销对比分析"]]></Attributes>
</O>
</widgetValue>
<LabelAttr verticalcenter="true" textalign="2" autoline="true"/>
<FRFont name="微软雅黑" style="0" size="96"/>
<Background name="ColorBackground" color="-1"/>
<border style="1" color="-657929"/>
</InnerWidget>
<BoundsAttr x="0" y="0" width="960" height="36"/>
</Widget>
<title class="com.fr.form.ui.Label">
...
<TemplateIdAttMark TemplateId="8549ea13-84ea-4f8a-a290-eab56b6f2f55"/>
</TemplateIdAttMark>
</Form>
