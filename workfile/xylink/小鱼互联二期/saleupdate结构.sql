...
CREATE TABLE `hs_report`  (
  ...
  `use_time` date NULL DEFAULT NULL,
  `ftaxnowsum` decimal(20, 2) NULL DEFAULT NULL,
  `port` varchar(50) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
...
select  a.cinvsn sn号码,a.cCusCode 客户编码,a.cCusName 客户名称,a.dDate 订单时间,a.cInvCode 存货料号,a.cInvName 存货名称,a.cSOCode 订单号,a.first_bind_timestamp 激活时间,a.pre 折扣,a.amount 总摊销费用,b.ftaxperiod 当月摊销,b.use_time 摊销时间,b.ftaxnowsum 累计摊销,c.`port` from  hs_load_order_data_hardwareservice a,
hs_data_period_detail b,
hardware_service_product_standard_price c
where  a.cinvsn=b.cinvsn 
and a.cInvCode=c.productcode
and  cast( DATE_FORMAT(a.dDate,'%Y%m') as signed) between cast(c.startperiod as signed) and cast(c.endperiod as signed) ;
...
BEGIN
 ...
 SELECT
	a.cinvsn,a.cCusCode,a.cCusName,a.dDate,a.cInvCode,a.cInvName,a.iQuantity,a.iTaxUnitPrice,a.iSum,a.cSOCode,a.iorderdid,case when a.cCusCode='100001129' and a.first_bind_timestamp is null then a.dDate ELSE a.first_bind_timestamp end first_bind_timestamp
FROM
