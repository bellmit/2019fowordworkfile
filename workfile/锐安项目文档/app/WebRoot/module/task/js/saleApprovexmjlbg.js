...
function milestone(json){
	var  html='<li class="clearfix "><span class="left label">变更成员：</span>'+
				'<input type="text" id="" class="f_input right wp60" value="'+json.proManager.proManagerName+'">'+
			'</li>'+
			'<li class="clearfix "><span class="left label">变更原因：</span> </br>'+
				'<input type="text" id="" class="f_input right wp60" value="'+json.proManager.ChangeReasons+'">'+
			'</li></br>';
