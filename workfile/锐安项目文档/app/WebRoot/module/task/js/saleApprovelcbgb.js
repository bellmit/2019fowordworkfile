...
function properties(json){
	$.each(json.relation.data,function(i,list){
		$("#startDate").val(list.proCode);
		var html='<li class="clearfix "><span class="left label">序号：</span>'+
			...
			'<li class="clearfix "><span class="left label">计划完成时间：</span> '+
				'<input type="text" id="" class="f_input right wp60" value="'+list.planFinishTimeStr+'">'+
			'</li>'+
			...
			'</li></br>'+
			'<li class="clearfix "><span class="left label">完成比例（%）：</span>'+
				'<input type="text" id="" class="f_input right wp60" value='+list.completionRatio+'>'+
			'</li>'+
			'<li class="clearfix "><span class="left label">备注：</span>'+
				'<input type="text" id="" class="f_input right wp60" value='+list.additionalReasons+'>'+
			'</li>'+
			'<li class="clearfix "><span class="left label">附件：</span>'+
				'<input type="text" id="" class="f_input right wp60"value="下载" >'+
			'</li>';
	...
	if(json.hasOwnProperty("pnrData")){
		$.each(json.pnrData,function(i,list){
			...
			var html='<li class="clearfix "><span class="left label">序号：</span>'+
					...
					'</li>'+
					'<li class="clearfix "><span class="left label">动作：</span>'+
						'<span type="text" id="" style="padding-right:20px">'+list.movement+'</span>'+
					'</li>'+
					'<li class="clearfix "><span class="left label">计划完成时间：</span> '+
						'<input type="text" id="" class="f_input right wp60" value="'+planFinishTime+'">'+
					'</li>'+
					'<li class="clearfix "><span class="left label">描述：</span>'+
						'<span type="text" id="" style="padding-right:20px">'+list.description+'</span>'+
					'</li>'+
					'<li class="clearfix "><span class="left label">执行人员：</span> '+
						'<input type="text" id="" class="f_input right wp60" value="'+list.executeRoleNames+'">'+
					'</li></br>';
