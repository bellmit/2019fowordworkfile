...
//生成费用增补信息
function zengbu(json){
	$.each(json.proBudget.budgets,function(i,list){
		var html='<li class="clearfix "><span class="left label">费用类型：</span>'+
			...
			'<li class="clearfix "><span class="left label">增补原因：</span>'+
				'<span  id="" class="f_input right wp60" >'+list.additionalReasons+'</span>'+
			'</li></br>';
		$("#zengbu").append(html);
	});
}
