...
Date: 2019-08-22 20:02:42
*/

SET FOREIGN_KEY_CHECKS=0;

-- ----------------------------
-- Table structure for ODS_FI_RGIC_TARGET
-- ----------------------------
DROP TABLE IF EXISTS `ODS_FI_RGIC_TARGET`;
CREATE TABLE `ODS_FI_RGIC_TARGET` (
  ...
  `IS_SYB` varchar(100) default NULL COMMENT '是否事业部【1 是 0 否】'
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COMMENT='确认收入目标表';
