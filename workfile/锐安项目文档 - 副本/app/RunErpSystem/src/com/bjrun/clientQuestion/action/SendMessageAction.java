...
//		obj.element("touser",userIds);
		...
		obj.element("msgtype","text");
      	obj.element("agentid","1000014");
      	obj.element("text",sb.toString());
  		String access_token = getWXAccess_token("http://10.200.200.35:8000/cgi-bin/gettoken?corpid=wla377739e7a&corpsecret=W8LvXytHLXrYrT0Xti9VHNCIDNWWRatnl02xCiFXzy4");
