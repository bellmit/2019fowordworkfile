OPTIONS (skip=1)
LOAD DATA
INFILE "/dw-data/EBS-DATA/20190116/csv/20190116_ap_invoices_all_201901.csv"
truncate
INTO TABLE EBS_AP_INVOICES_ALL
...
(
  ...
  PO_HEADER_ID                  					,
  FREIGHT_AMOUNT                					,
  GOODS_RECEIVED_DATE           					DATE"DD-MM-YY",
  INVOICE_RECEIVED_DATE         					DATE"DD-MM-YY",
  VOUCHER_NUM                   					,
  APPROVED_AMOUNT               					,
  ...
  PAYMENT_CROSS_RATE_DATE       					DATE"DD-MM-YY",
  PAY_CURR_INVOICE_AMOUNT       					,
  MRC_BASE_AMOUNT               					,
  MRC_EXCHANGE_RATE             					,
  MRC_EXCHANGE_RATE_TYPE        					,
  MRC_EXCHANGE_DATE             					DATE"DD-MM-YY",
  GL_DATE                       					DATE"DD-MM-YY",
  AWARD_ID                      					,
  ...
  SUPPLIER_TAX_INVOICE_DATE     					DATE"DD-MM-YY",
  SUPPLIER_TAX_EXCHANGE_RATE    					,
  TAX_INVOICE_RECORDING_DATE    					DATE"DD-MM-YY",
